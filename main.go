...
import (
	...
	"github.com/yangkailc/bigtree-dns/controller"
	"github.com/yangkailc/bigtree-dns/endpoint"
	"github.com/yangkailc/bigtree-dns/pkg/apis/externaldns"
	"github.com/yangkailc/bigtree-dns/pkg/apis/externaldns/validation"
	"github.com/yangkailc/bigtree-dns/plan"
	"github.com/yangkailc/bigtree-dns/provider"
	"github.com/yangkailc/bigtree-dns/provider/akamai"
	"github.com/yangkailc/bigtree-dns/provider/alibabacloud"
	"github.com/yangkailc/bigtree-dns/provider/aws"
	"github.com/yangkailc/bigtree-dns/provider/awssd"
	"github.com/yangkailc/bigtree-dns/provider/azure"
	"github.com/yangkailc/bigtree-dns/provider/cloudflare"
	"github.com/yangkailc/bigtree-dns/provider/coredns"
	"github.com/yangkailc/bigtree-dns/provider/designate"
	"github.com/yangkailc/bigtree-dns/provider/digitalocean"
	"github.com/yangkailc/bigtree-dns/provider/dnsimple"
	"github.com/yangkailc/bigtree-dns/provider/dyn"
	"github.com/yangkailc/bigtree-dns/provider/exoscale"
	"github.com/yangkailc/bigtree-dns/provider/google"
	"github.com/yangkailc/bigtree-dns/provider/hetzner"
	"github.com/yangkailc/bigtree-dns/provider/infoblox"
	"github.com/yangkailc/bigtree-dns/provider/inmemory"
	"github.com/yangkailc/bigtree-dns/provider/linode"
	"github.com/yangkailc/bigtree-dns/provider/ns1"
	"github.com/yangkailc/bigtree-dns/provider/oci"
	"github.com/yangkailc/bigtree-dns/provider/ovh"
	"github.com/yangkailc/bigtree-dns/provider/pdns"
	"github.com/yangkailc/bigtree-dns/provider/rcode0"
	"github.com/yangkailc/bigtree-dns/provider/rdns"
	"github.com/yangkailc/bigtree-dns/provider/rfc2136"
	"github.com/yangkailc/bigtree-dns/provider/scaleway"
	"github.com/yangkailc/bigtree-dns/provider/transip"
	"github.com/yangkailc/bigtree-dns/provider/ultradns"
	"github.com/yangkailc/bigtree-dns/provider/vinyldns"
	"github.com/yangkailc/bigtree-dns/provider/vultr"
	"github.com/yangkailc/bigtree-dns/registry"
